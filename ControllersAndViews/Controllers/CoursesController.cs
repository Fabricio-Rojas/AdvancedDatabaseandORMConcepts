...
namespace ControllersAndViews.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(ControllersAndViewsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Course != null ? 
                ...
                Problem("Entity set 'ControllersAndViewsContext.Course'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ControllersAndViewsContext.Course'  is null.");
            }
            var course = await _context.Course.FindAsync(id);
            if (course != null)
            {
